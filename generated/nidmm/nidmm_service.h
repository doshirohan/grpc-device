...
private:
  ...
  std::map<std::int32_t, std::int32_t> aperturetime_input_map_ { {0, 0},{1, -1},{2, 1},{3, 5},{4, 6},{5, 10},{6, 12},{7, 100},{8, 120}, };
  std::map<std::int32_t, std::int32_t> aperturetime_output_map_ { {0, 0},{-1, 1},{1, 2},{5, 3},{6, 4},{10, 5},{12, 6},{100, 7},{120, 8}, };
  std::map<std::int32_t, std::int32_t> frequencyvoltagerange_input_map_ { {0, 0},{1, -1},{2, -2}, };
  std::map<std::int32_t, std::int32_t> frequencyvoltagerange_output_map_ { {0, 0},{-1, 1},{-2, 2}, };
  std::map<std::int32_t, std::int32_t> powerlinefrequencies_input_map_ { {0, 0},{1, 50},{2, 60}, };
  std::map<std::int32_t, std::int32_t> powerlinefrequencies_output_map_ { {0, 0},{50, 1},{60, 2}, };
  std::map<std::int32_t, std::int32_t> sampleinterval_input_map_ { {0, 0},{1, -1}, };
  std::map<std::int32_t, std::int32_t> sampleinterval_output_map_ { {0, 0},{-1, 1}, };
  std::map<std::int32_t, std::int32_t> triggerdelays_input_map_ { {0, 0},{1, -1},{2, -2}, };
  std::map<std::int32_t, std::int32_t> triggerdelays_output_map_ { {0, 0},{-1, 1},{-2, 2}, };
