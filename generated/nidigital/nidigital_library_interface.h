...
class NiDigitalLibraryInterface {
 public:
  ...
  virtual ViStatus ClockGenerator_Abort(ViSession vi, ViConstString channelList) = 0;
  virtual ViStatus ClockGenerator_GenerateClock(ViSession vi, ViConstString channelList, ViReal64 frequency, ViBoolean selectDigitalFunction) = 0;
  ...
  virtual ViStatus FrequencyCounter_MeasureFrequency(ViSession vi, ViConstString channelList, ViInt32 frequenciesBufferSize, ViReal64 frequencies[], ViInt32* actualNumFrequencies) = 0;
  ...
  virtual ViStatus PPMU_Measure(ViSession vi, ViConstString channelList, ViInt32 measurementType, ViInt32 bufferSize, ViReal64 measurements[], ViInt32* actualNumRead) = 0;
  virtual ViStatus PPMU_Source(ViSession vi, ViConstString channelList) = 0;
  ...
  virtual ViStatus self_test(ViSession vi, ViInt16* testResult, ViChar testMessage[2048]) = 0;
};
